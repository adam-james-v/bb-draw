...
#+NAME: deps
#+begin_src babashka :var deps=deps.edn :results raw
#!/usr/bin/env bb
...
#+RESULTS[3e7540ea6b8c45c7c88e68f74d258cad5c3c6d6d]:
[[file:petal.svg]]
That's a pretty nice result! I think that making a petal function can help me make various petal sizes quickly and easily, which lets me make a more varied flower. So, I'll pull the various ideas from the above snippet into a function.
...
[[twitch.tv/adam_james_tv]]

And have a Youtube Channel where I post nice edited videos:

[[youtube.com/c/AdamJames-tv]]

Ok, that's enough self promotion.

Please, have fun messing around with this code!
...
#+RESULTS[ff207b655fb2146170589695a89927820f7c58f9]:
[[file:02.svg]]
...
#+RESULTS[82be6a4a462ec0499b3b7b5045f60e2263132994]: flower
[[file:03.svg]]
